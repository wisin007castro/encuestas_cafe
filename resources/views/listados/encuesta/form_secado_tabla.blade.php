...
<div class="col-md-8">
    ...
    <div class="box-header with-border bg-primary">
		...
		<a href="{{route('form_secado_agregar')}}" class="btn btn-block btn-success btn-sm">
...
<div class="box-body box-white">
    <div class="table-responsive" >
		...
		@php
			$id_secado_encode = base64_encode($dato->id_secado)
		@endphp
		 <tr role="row" class="odd">
			<td>{{ $key + 1 }}</td>
			<td>{{ f_formato($dato->updated_at) }}</td>
			<td>
				<a href="{{route('form_secado_editar', ['id_secado' => $id_secado_encode])}}" class="btn-accion-tabla">
