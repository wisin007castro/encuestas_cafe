...
<div class="col-md-8">
    ...
    <div class="box-header with-border bg-primary">
        ...
        <div class="box-tools pull-right">
						<a href="{{route('form_fertilizaciones_agregar')}}" class="btn btn-block btn-success btn-sm">
...
<div class="box-body box-white">
    <div class="table-responsive" >
		...
		@php
			$id_fertilizacion_encode = base64_encode($dato->id_fertilizacion)
		@endphp
		 <tr role="row" class="odd">
			<td>{{ $key + 1 }}</td>
			<td>{{ f_formato($dato->updated_at) }}</td>
			<td>
				<a href="{{route('form_fertilizaciones_editar', ['id_fertilizacion' => $id_fertilizacion_encode])}}" class="btn-accion-tabla">
