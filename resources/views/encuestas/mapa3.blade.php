...
<html lang="en">
    ...
    <body>
        ...
        var layer_enc_productores_2 = L.WMS.layer("http://3.16.160.175:8080/geoserver/encuestas_cafe/wms", "enc_productores", {
            format: 'image/png',
            uppercase: true,
            transparent: true,
        ...
        var baseMaps = {};
        L.control.layers(baseMaps,{"enc_productores": layer_enc_productores_2,'<img src="legend/MUNICIPIOS_1.png" /> MUNICIPIOS': layer_MUNICIPIOS_1,"OpenStreetMap": layer_OpenStreetMap_0,}).addTo(map);
        setBounds();
        var i = 0;
