              ...
              <div class="col-sm-6 col-sm-offset-3 myform-cont" >
                 ...
                 <div class="myform-top">
                  ...
                  <div class="col-md-12" >
                    ...
                    <form action="{{ route('plagas_guardar') }}" method="post" class="">
                      <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        ...
                        <div class="form-group">
                          <label >¿Detectó la Plaga Broca?</label>
													<br>
													<input type="radio" id="broca_si" name="broca" value="1" onchange="mostrar_broca()" checked> Si &nbsp;&nbsp;&nbsp;&nbsp;
													<input type="radio" id="broca_no" name="broca" value="0" onchange="mostrar_broca()"> No
												</div>

												<div class="content_broca" id="content_broca">
													<div class="form-group">
														<label >Fecha</label>
														<input type="date" name="broca_fecha" id="broca_fecha" class="form-control" required>
													</div>
						                  ...
						                  <option value="Frutos">Frutos</option>
													...
													<div class="form-group">
														...
														<input type="number" min="0" max="100" step="0.01" name="broca_incidencia" id="broca_incidencia" class="form-control" required>
	                        </div>

													<div class="form-group">
														<label >Control Recomendado</label>
														<input type="text" name="broca_control" id="broca_control" class="form-control" required>
													</div>
												</div>
                        ...
                        <div class="form-group">
                          <label >¿Detectó la Plaga Cepe?</label>
													<br>
													<input type="radio" id="cepe_si" name="cepe" value="1" onchange="mostrar_cepe()" checked> Si &nbsp;&nbsp;&nbsp;&nbsp;
													<input type="radio" id="cepe_no" name="cepe" value="0" onchange="mostrar_cepe()"> No
												</div>

												<div class="content_cepe" id="content_cepe">
													<div class="form-group">
														<label >Fecha</label>
														<input type="date" name="cepe_fecha" id="cepe_fecha" class="form-control" required>
													</div>
						                  ...
						                  <option value="Frutos">Frutos</option>
													...
													<div class="form-group">
														<label >Porcentaje de Incidencia (%)</label>
														<input type="number" min="0" max="100" step="0.01" name="cepe_incidencia" id="cepe_incidencia" class="form-control" required>
	                        </div>

													<div class="form-group">
														<label >Control Recomendado</label>
														<input type="text" name="cepe_control" id="cepe_control" class="form-control" required>
													</div>
												</div>
                        ...
                        <div class="form-group">
                          <label >¿Detectó la Plaga Grillo (Tucura)?</label>
													<br>
													<input type="radio" id="grillo_si" name="grillo" value="1" onchange="mostrar_grillo()" checked> Si &nbsp;&nbsp;&nbsp;&nbsp;
													<input type="radio" id="grillo_no" name="grillo" value="0" onchange="mostrar_grillo()"> No
												</div>

												<div class="content_grillo" id="content_grillo">
													<div class="form-group">
														<label >Fecha</label>
														<input type="date" name="grillo_fecha" id="grillo_fecha" class="form-control" required>
													</div>
						                  ...
						                  <option value="Frutos">Frutos</option>
													...
													<div class="form-group">
														<label >Porcentaje de Incidencia (%)</label>
														<input type="number" min="0" max="100" step="0.01" name="grillo_incidencia" id="grillo_incidencia" class="form-control" required>
	                        </div>

													<div class="form-group">
														<label >Control Recomendado</label>
														<input type="text" name="grillo_control" id="grillo_control" class="form-control" required>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<br>
													<input type="radio" id="cochinilla_si" name="cochinilla" value="1" onchange="mostrar_cochinilla()" checked> Si &nbsp;&nbsp;&nbsp;&nbsp;
													<input type="radio" id="cochinilla_no" name="cochinilla" value="0" onchange="mostrar_cochinilla()"> No
												</div>

												<div class="content_cochinilla" id="content_cochinilla">
													<div class="form-group">
														<label >Fecha</label>
														<input type="date" name="cochinilla_fecha" id="cochinilla_fecha" class="form-control" required>
													</div>
													...
													<div class="form-group">
														<label >Porcentaje de Incidencia (%)</label>
														<input type="number" min="0" max="100" step="0.01" name="cochinilla_incidencia" id="cochinilla_incidencia" class="form-control" required>
													</div>

													<div class="form-group">
														<label >Control Recomendado</label>
														<input type="text" name="cochinilla_control" id="cochinilla_control" class="form-control" required>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<br>
													<input type="radio" id="escamas_si" name="escamas" value="1" onchange="mostrar_escamas()" checked> Si &nbsp;&nbsp;&nbsp;&nbsp;
													<input type="radio" id="escamas_no" name="escamas" value="0" onchange="mostrar_escamas()"> No
												</div>

												<div class="content_escamas" id="content_escamas">
													<div class="form-group">
														<label >Fecha</label>
														<input type="date" name="escamas_fecha" id="escamas_fecha" class="form-control" required>
													</div>
													...
													<div class="form-group">
														<label >Porcentaje de Incidencia (%)</label>
														<input type="number" min="0" max="100" step="0.01" name="escamas_incidencia" id="escamas_incidencia" class="form-control" required>
													</div>

													<div class="form-group">
														<label >Control Recomendado</label>
														<input type="text" name="escamas_control" id="escamas_control" class="form-control" required>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<br>
													<input type="radio" id="minador_si" name="minador" value="1" onchange="mostrar_minador()" checked> Si &nbsp;&nbsp;&nbsp;&nbsp;
													<input type="radio" id="minador_no" name="minador" value="0" onchange="mostrar_minador()"> No
												</div>

												<div class="content_minador" id="content_minador">
													<div class="form-group">
														<label >Fecha</label>
														<input type="date" name="minador_fecha" id="minador_fecha" class="form-control" required>
													</div>
													...
													<div class="form-group">
														<label >Porcentaje de Incidencia (%)</label>
														<input type="number" min="0" max="100" step="0.01" name="minador_incidencia" id="minador_incidencia" class="form-control" required>
													</div>

													<div class="form-group">
														<label >Control Recomendado</label>
														<input type="text" name="minador_control" id="minador_control" class="form-control" required>
													</div>
												</div>
												...
												<br>
												<h4 style="color:white">Plaga: Barrenador del Tallo</h4>
												<div class="form-group">
													<label >¿Detectó la Plaga Barrenador del Tallo?</label>
													<br>
													<input type="radio" id="barrenador_si" name="barrenador" value="1" onchange="mostrar_barrenador()" checked> Si &nbsp;&nbsp;&nbsp;&nbsp;
													<input type="radio" id="barrenador_no" name="barrenador" value="0" onchange="mostrar_barrenador()"> No
												</div>

												<div class="content_barrenador" id="content_barrenador">
													<div class="form-group">
														<label >Fecha</label>
														<input type="date" name="barrenador_fecha" id="barrenador_fecha" class="form-control" required>
													</div>
													...
													<div class="form-group">
														<label >Porcentaje de Incidencia (%)</label>
														<input type="number" min="0" max="100" step="0.01" name="barrenador_incidencia" id="barrenador_incidencia" class="form-control" required>
													</div>

													<div class="form-group">
														<label >Control Recomendado</label>
														<input type="text" name="barrenador_control" id="barrenador_control" class="form-control" required>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<br>
													<input type="radio" id="nematodos_si" name="nematodos" value="1" onchange="mostrar_nematodos()" checked> Si &nbsp;&nbsp;&nbsp;&nbsp;
													<input type="radio" id="nematodos_no" name="nematodos" value="0" onchange="mostrar_nematodos()"> No
												</div>

												<div class="content_nematodos" id="content_nematodos">
													<div class="form-group">
														<label >Fecha</label>
														<input type="date" name="nematodos_fecha" id="nematodos_fecha" class="form-control" required>
													</div>
													...
													<div class="form-group">
														<label >Porcentaje de Incidencia (%)</label>
														<input type="number" min="0" max="100" step="0.01" name="nematodos_incidencia" id="nematodos_incidencia" class="form-control" required>
													</div>

													<div class="form-group">
														<label >Control Recomendado</label>
														<input type="text" name="nematodos_control" id="nematodos_control" class="form-control" required>
													</div>
												</div>
