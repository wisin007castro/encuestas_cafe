...
wms.Source = L.Layer.extend({
    ...
    'parseFeatureInfo': function(result, url) {
        ...
        if (result == "error") {
            ...
            //result = "<embed src='http://18.225.6.4:8080/geoserver/encuestas_cafe/wms?service=WMS&request=GetFeatureInfo&version=1.1.1&layers=enc_productores&styles=&format=image%2Fpng&transparent=true&continuousWorld=true&tiled=true&info_format=text%2Fhtml&width=1035&height=540&srs=EPSG%3A3857&bbox=-8137791.779353007%2C-1571545.3015432232%2C-6871994.590950486%2C-911129.3771593018&query_layers=enc_productores&X=400&Y=281' width=200 height=200 />";
            //result = "<embed src='http://www.somesite.com' width=200 height=200 />";
            //result = "<a href="+url+" target='_blank'>Info</a>";
            result = "<iframe src='" + url + "' style='border:none'>";
            //result = "<iframe src='http://www.somesite.com' style='border:none'>";
        }
        return result;
    },
